...
contract OOGWAY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9bE8D4Db4dcc7b70A1ECa80D0bA52ea9c1D66488); // Marketing Address
    address payable public charityAddress = payable(0x2bAA808B44737Cf6078C03902f83A364e9599319); // Charity Address
